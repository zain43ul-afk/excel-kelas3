...
(() => {
  ...
  // Esc dicegah pada level halaman jika browser meneruskannya ke dokumen.
  // Browser tetap dapat menyediakan jalur keluar fullscreen sendiri; jika itu
  // terjadi, overlay langsung mengunci aplikasi.
  document.addEventListener("keydown",e=>{
    if(!studentSessionExists() || !fullscreenActive())return;

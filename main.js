      ...
      <section class="alg-race-wait-card">
        ...
        <div class="alg-race-wait-content">
          ...
          <div class="alg-race-wait-status">
            <div><span class="alg-race-status-icon">●</span><small>Status Anda</small><strong>\${info.assigned?\`Tim \${info.groupNo}\`:"Sudah masuk halaman"}</strong></div>
            ...
            <div><span class="alg-race-status-icon">▶</span><small>Permainan</small><strong>\${started?"Sedang dimulai":"Belum dimulai"}</strong></div>
          </div>
